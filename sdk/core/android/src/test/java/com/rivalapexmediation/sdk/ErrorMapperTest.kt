...
class ErrorMapperTest {
    ...
    fun moloco_maps_no_fill_and_timeout() {
        ...
        assertTrue(nf is AdapterError.Fatal)
    ...
    fun ironsource_maps_config_and_timeout() {
        ...
        assertEquals(ErrorCode.CONFIG, cfg.code)
    ...
    fun pangle_and_mintegral_map_expected() {
        ...
        assertTrue(mNf is AdapterError.Fatal)
    ...
    fun vungle_tapjoy_smaato_mappings_cover_no_fill_network_timeout() {
        ...
        assertTrue(vNoFill is AdapterError.Fatal)
        ...
        assertTrue(sNoFill is AdapterError.Fatal)
