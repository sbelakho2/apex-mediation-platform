...
class Adapter : AdNetworkAdapter {
    ...
    override fun initialize(context: Context, config: Map<String, Any>) {
        val placementId = config["placement_id"] as? String
            ?: throw IllegalArgumentException("placement_id required")
        initialized = placementId.isNotBlank()
    }
    ...
    override fun loadAd(
        ...
        val ad = Ad(
            ...
            adType = adType,
            ecpm = 1.01,
            creative = Creative.Banner(width = 320, height = 50, markupHtml = "<div>Facebook AN Mock</div>")
        )
