package com.rivalapexmediation.adapter.chartboost
...
class Adapter : AdNetworkAdapter {
    override val networkName: String = "chartboost"
    ...
    override fun loadAd(
        ...
        val ad = Ad(
            ...
            adType = adType,
            ecpm = 1.06,
            creative = Creative.Banner(width = 320, height = 50, markupHtml = "<div>Chartboost Mock</div>")
        )
