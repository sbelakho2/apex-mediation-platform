...
class Adapter : AdNetworkAdapter {
    override val networkName: String = "amazon"
    ...
    override fun initialize(context: Context, config: Map<String, Any>) {
        val appKey = config["app_key"] as? String ?: throw IllegalArgumentException("app_key required")
        initialized = appKey.isNotBlank()
    }
    ...
    override fun loadAd(
        ...
        val ad = Ad(
            ...
            adType = adType,
            ecpm = 1.13,
            creative = Creative.Banner(width = 320, height = 50, markupHtml = "<div>Amazon APS Mock</div>")
        )
