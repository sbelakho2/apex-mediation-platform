...
class Adapter : AdNetworkAdapter {
    override val networkName: String = "smaato"
    ...
    override fun initialize(context: Context, config: Map<String, Any>) {
        val publisherId = config["publisher_id"] as? String
            ?: throw IllegalArgumentException("publisher_id required")
        initialized = publisherId.isNotBlank()
    }
    ...
    override fun loadAd(
        ...
        val ad = Ad(
            ...
            adType = adType,
            ecpm = 1.11,
            creative = Creative.Banner(width = 320, height = 50, markupHtml = "<div>Smaato Mock</div>")
        )
