...
class Adapter : AdNetworkAdapter {
    override val networkName: String = "tapjoy"
    ...
    override fun initialize(context: Context, config: Map<String, Any>) {
        val sdkKey = config["sdk_key"] as? String ?: throw IllegalArgumentException("sdk_key required")
    ...
    override fun loadAd(
        ...
        val ad = Ad(
            ...
            adType = adType,
            ecpm = 1.09,
            creative = Creative.Banner(width = 320, height = 50, markupHtml = "<div>Tapjoy Mock</div>")
        )
