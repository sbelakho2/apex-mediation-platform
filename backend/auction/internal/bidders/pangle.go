...
// PangleAdapter implements a minimal S2S bidder for Pangle with standardized resiliency
...
func NewPangleAdapter(appID, apiKey string) *PangleAdapter {
	return &PangleAdapter{
		appID:  appID,
		apiKey: apiKey,
...
func (a *PangleAdapter) GetName() string { return "pangle" }
func (a *PangleAdapter) GetTimeout() time.Duration { return 5 * time.Second }

func (a *PangleAdapter) RequestBid(ctx context.Context, req BidRequest) (*BidResponse, error) {
	...
	endpoint := "https://api.pangle.com/s2s/bid"
