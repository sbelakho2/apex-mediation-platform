...
- [ ] Request flow:
  ...
  3. Send POST to `https://api.apexmediation.ee/v1/auction` (or configured endpoint)
...
- [ ] Create `SDKConfig.cs` as `ScriptableObject`:
  ...
  public class SDKConfig : ScriptableObject
  {
      ...
      [Header("Network")]
      public string AuctionEndpoint = "https://api.apexmediation.ee/v1/auction";
      public string ConfigEndpoint = "https://api.apexmediation.ee/v1/config";
...
- [ ] Fetch flow:
  ...
  3. Fetch fresh config from `https://api.apexmediation.ee/v1/config?app_id={appId}`
